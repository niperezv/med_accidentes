...
with tab2:
    ...
    fecha_inicio = st.date_input('Fecha de inicio', pd.to_datetime('2020-09-01'))
    ...
    Prediccion_intervalo = predicciondf[(predicciondf['FECHA'] >= fecha_inicio) & (predicciondf['FECHA'] <= fecha_fin)]
    ...
    if fecha_inicio is not None and fecha_fin is not None and prect_clase is not None:
        ...
        Prediccion_intervalo2 = pd.concat([Prediccion_intervalo, Prediccion_intervalo_df], axis=1)
